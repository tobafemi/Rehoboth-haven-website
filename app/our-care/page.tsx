        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="space-y-16">
            {careServices.map((service, index) => (
              <div
                key={service.name}
                className={`grid gap-12 lg:grid-cols-2 ${index % 2 === 1 ? 'lg:grid-flow-dense' : ''}`}
              >
                <div className={index % 2 === 1 ? 'lg:col-start-2' : ''}>
                  <div className="aspect-w-16 aspect-h-9 bg-gradient-to-br from-primary/20 to-primary/5 rounded-lg flex items-center justify-center">
